...
var display_text : String : get = get_display_text
var stat : set = set_stat
var value_min : float
var value_max : float
var price_modifier : float
var min_lvl : int : set = set_level
var is_suffix : bool = false


func _init(text: String = "", stat = 999, value_min: float = 0.0, value_max: float = 0.0, price_modifier: float = 1.0, min_lvl: int = 0, is_suffix = false):
